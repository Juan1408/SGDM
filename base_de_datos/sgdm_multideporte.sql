-- =============================================================================
-- SCRIPT SQL COMPLETO – BASE DE DATOS ASCEND VERSIÓN MULTIDEPORTIVA
...
VALUES (
        'crear_torneos',
        'Puede crear nuevos torneos'
    ),
    (
        'editar_torneos',
        'Puede modificar torneos existentes'
    ),
    (
        'borrar_torneos',
        'Puede eliminar torneos del sistema'
    ),
    (
        'crear_usuarios',
        'Puede crear usuarios administrativos'
    ),
    (
        'enviar_mensajes',
        'Puede enviar comunicados masivos'
    ),
    (
        'descargar_reportes',
        'Puede descargar reportes del sistema'
    ),
    (
        'ver_auditoria',
        'Puede ver los registros de acciones'
    );
...
VALUES (
    ...
    (
        'Organizador',
        'Puede crear y administrar torneos',
        2
    ),
    (
        'Participante',
        'Puede unirse a equipos y participar',
        1
    ),
    (
        'Usuario Publico',
...
INSERT INTO
    modalidades (nombre, descripcion)
VALUES (
        'individual',
        'Participantes individuales (una persona por participante)'
    ),
    (
        'equipos',
        'Participantes son equipos de múltiples miembros'
    );
...
VALUES (
        ...
        1,
        0,
        'Estándar: 3 puntos por victoria, 1 por empate, 0 por derrota'
    ),
    (
        'ajedrez',
        1,
        0.5,
        0,
        'Sistema de ajedrez: 1 punto por victoria, 0.5 por tablas, 0 por derrota'
    ),
    (
        'puntos_mapa',
        2,
        1,
        0,
        'Para videojuegos: 2 puntos por victoria de mapa, 1 por empate (raro), 0 derrota'
    );
